...
export const seoMetadataKH: Record<string, SEOMetadata> = {
  '/': {
    title: 'ភោជនីយដ្ឋាន វ័នម៉រ | អាហារខ្មែរពិតៗ ក្នុងរាជធានីភ្នំពេញ',
    description: 'រីករាយជាមួយរសជាតិអាហារខ្មែរពិតៗនៅភោជនីយដ្ឋាន វ័នម៉រ។ ស្វែងយល់ពីមុខម្ហូប កក់បន្ទប់ពិសារអាហារឯកជន និងរីករាយជាមួយសេវាកម្មដ៏ល្អឥតខ្ចោះ។',
    keywords: 'ភោជនីយដ្ឋាន វ័នម៉រ, អាហារខ្មែរពិតៗ, ម្ហូបខ្មែរភ្នំពេញ, ភោជនីយដ្ឋានលំដាប់ខ្ពស់, បន្ទប់អាហារឯកជន, ម្ហូបប្រពៃណីខ្មែរ, អាហារដ្ឋានភ្នំពេញ',
    ogImage: '/logo-share.jpg'
  },
  '/menu': {
    title: 'បញ្ជីមុខម្ហូបខ្មែរពិតៗ | ភោជនីយដ្ឋាន វ័នម៉រ',
    description: 'ស្វែងយល់ពីបេតិកភណ្ឌអាហារខ្មែរដ៏សម្បូរបែប។ រីករាយជាមួយមុខម្ហូបប្រពៃណី ស៊ុបពិសេសៗ និងអាហារសម្រន់ក្នុងស្រុក។',
    keywords: 'មុខម្ហូបភោជនីយដ្ឋានវ័នម៉រ, បញ្ជីមុខម្ហូបខ្មែរ, ម្ហូបខ្មែរប្រពៃណី, ស៊ុបខ្មែរពិសេសៗ, អាហារខ្មែររសជាតិដើម',
    ogImage: '/images/menu-share.jpg'
  },
  '/events': {
    title: 'រៀបចំកម្មវិធី និងអាហារសម្រន់ | ភោជនីយដ្ឋាន វ័នម៉រ',
  ...
  '/branches': {
    title: 'សាខារបស់យើង ក្នុងភ្នំពេញ | ភោជនីយដ្ឋាន វ័នម៉រ',
    description: 'អញ្ជើញមកកាន់ភោជនីយដ្ឋាន វ័នម៉រ ក្នុងទីក្រុងភ្នំពេញ។ ស្វែងយល់ពីសាខាទួលគោក និងបឹងកក់ របស់យើង ដែលមានបន្ទប់ VIP ពិសេសៗ។',
    keywords: 'សាខាភោជនីយដ្ឋានវ័នម៉រ, វ័នម៉រទួលគោក, វ័នម៉របឹងកក់, បន្ទប់ VIP ភ្នំពេញ, អាហារដ្ឋានសួនច្បារ',
    ogImage: '/images/branches-share.jpg'
  },
  '/branches/toul-kork': {
    title: 'ភោជនីយដ្ឋាន វ័នម៉រ - សាខាទួលគោក',
    description: 'រីករាយជាមួយការពិសាអាហារខ្មែរពិតៗនៅភោជនីយដ្ឋាន វ័នម៉រ ទួលគោក។ ស័ក្តិសមសម្រាប់ជំនួបគ្រួសារ ការចរចាអាជីវកម្ម និងកម្មវិធីជប់លៀងផ្សេងៗ។',
    keywords: 'ភោជនីយដ្ឋានវ័នម៉រទួលគោក, ទួលគោកអាហារដ្ឋាន, បន្ទប់ឯកជនទួលគោក, ជួបជុំគ្រួសារទួលគោក',
    ogImage: '/images/toul-kork-share.jpg'
  },
  '/branches/boeung-kak': {
    title: 'ភោជនីយដ្ឋាន វ័នម៉រ - សាខាបឹងកក់',
    description: 'រីករាយជាមួយរសជាតិអាហារខ្មែរដ៏ឈ្ងុយឆ្ងាញ់នៅភោជនីយដ្ឋាន វ័នម៉រ បឹងកក់។ បរិយាកាសស្ងប់ស្ងាត់ បន្ទប់ឯកជនទំនើប និងសួនច្បារដ៏ស្រស់ស្អាត។',
    keywords: 'ភោជនីយដ្ឋានវ័នម៉របឹងកក់, បឹងកក់អាហារដ្ឋាន, បន្ទប់ឯកជនបឹងកក់, អាហារដ្ឋានសួនច្បារបឹងកក់',
    ogImage: '/images/boeung-kak-share.jpg'
  },
  '/gallery': {
    title: 'រូបភាព និងវិចិត្រសាល | ភោជនីយដ្ឋាន វ័នម៉រ',
    description: 'ទស្សនារូបភាពមុខម្ហូបខ្មែរប្រពៃណី បន្ទប់អាហារឯកជន និងទិដ្ឋភាពទូទៅនៃភោជនីយដ្ឋាន វ័នម៉រ។',
    keywords: 'រូបភាពភោជនីយដ្ឋានវ័នម៉រ, រូបភាពម្ហូបខ្មែរ, រូបភាពបន្ទប់អាហារ VIP, ទិដ្ឋភាពភោជនីយដ្ឋាន',
    ogImage: '/images/gallery-share.jpg'
  },
  '/about': {
    title: 'ប្រវត្តិនៃការបង្កើត | ភោជនីយដ្ឋាន វ័នម៉រ',
    description: 'ស្វែងយល់អំពីឆន្ទៈរបស់យើងក្នុងការថែរក្សាបេតិកភណ្ឌអាហារខ្មែរ។ អានប្រវត្តិ និងតម្លៃស្នូលរបស់ភោជនីយដ្ឋាន វ័នម៉រ។',
    keywords: 'ប្រវត្តិភោជនីយដ្ឋានវ័នម៉រ, ការថែរក្សាម្ហូបខ្មែរ, ស្នាដៃម្ហូបខ្មែរប្រពៃណី, តម្លៃស្នូលវ័នម៉រ',
    ogImage: '/images/about-share.jpg'
  },
  '/reservations': {
    title: 'កក់តុ និងបន្ទប់ VIP ទុកមុន | ភោជនីយដ្ឋាន វ័នម៉រ',
    description: 'កក់តុ ឬបន្ទប់ VIP ឯកជនរបស់អ្នកនៅភោជនីយដ្ឋាន វ័នម៉រ ដោយងាយស្រួល និងរហ័សទាន់ចិត្ត សម្រាប់អាហារជួបជុំផ្សេងៗ។',
  ...
  '/careers': {
    title: 'ឱកាសការងារ និងចូលរួមក្រុមការងារ | ភោជនីយដ្ឋាន វ័នម៉រ',
    description: 'កសាងអាជីពរបស់អ្នកក្នុងវិស័យបដិសណ្ឋារកិច្ចជាមួយភោជនីយដ្ឋាន វ័នម៉រ។ ស្វែងរកឱកាសការងារផ្នែកចម្អិនអាហារ សេវាកម្ម និងការគ្រប់គ្រង។',
    keywords: 'ការងារភោជនីយដ្ឋានភ្នំពេញ, ឱកាសការងារចុងភៅ, ការងារសេវាកម្មអាហារ, ជ្រើសរើសបុគ្គលិកវ័នម៉រ',
    ogImage: '/images/careers-share.jpg'
  },
  '/contact': {
    title: 'ទាក់ទងមកយើងខ្ញុំ និងផែនទីទីតាំង | ភោជនីយដ្ឋាន វ័នម៉រ',
