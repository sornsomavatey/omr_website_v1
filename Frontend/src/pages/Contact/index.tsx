  ...
  return (
    <div className="pt-28 pb-20 max-w-7xl mx-auto px-4">
      <div className="max-w-2xl mx-auto text-center mb-12">
        <h1 className="text-4xl font-bold font-serif text-dark-green mb-4">Contact Us</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
        {/* Contact info */}
        <div className="space-y-8 bg-white border border-gold/15 p-8 rounded-lg shadow-sm">
          ...
          <ul className="space-y-6">
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-olive/90 mt-1">info@onemore.com.kh</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        {/* Message form */}
        <div className="bg-white border border-gold/15 p-8 rounded-lg shadow-sm">
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <input type="email" className="w-full border border-gold/20 rounded-md py-2 px-3 focus:outline-none focus:border-gold" required />
            </div>
            <div>
