...
export const BranchesEditor: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    const result = await savePageJson('restaurants.json', data);
    setSaving(false);
    setMessage(`Successfully saved Branch details for ${currentLangInfo.flag} ${currentLangInfo.label}!`);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#2d402f] pb-4 gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold text-neutral-100 font-serif tracking-wide">Restaurant Branches Editor</h1>
